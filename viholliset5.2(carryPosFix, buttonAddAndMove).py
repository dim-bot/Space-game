...
play_button = button(width/2-50, height/2+50, 'Play')
options_button = button(width/2-50, height/2+100, 'Options')
score_button = button(width/2-50, height/2+150, 'Scores')
quit_button = button(width/2-50, height/2+200, 'Quit')
back_button = button(width/2-50, height/2+200, 'Back')
credit_button = button(width/2-50, height/2+150, 'Credits')
...
def options_menu():
    ...
    control_menu = button(width/2-50, height/2+100, 'Controls')
...
def credits():
    ...
    label_guru = main_font.render("Koodi Guru:", 1, (255,255,255))
