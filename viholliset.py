...
play_button = button(width/2-40, height/2, 'Play')
options_button = button(width/2-40, height/2+50, 'Options')
score_button = button(width/2-40, height/2+100, 'Scores')
quit_button = button(width/2-40, height/2+150, 'Quit')
...
def main():
    ...
    while run:
        ...
        redraw_window()
        game_looped += 1
        game_score = int(game_looped/FPS)
...
def options_menu():
    #make volume control and credits here
    print("options")

def high_scores():
    #recorded highscores go here
    print("high scores")
